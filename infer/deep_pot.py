...
class DeepPot(DeepEval):
        ...
        self.tensors = dict(
            {
                ...
                "t_type": "t_type:0",
                "t_natoms": "t_natoms:0",
                "t_natoms_banidx": "t_natoms_banidx:0",  #cjx_mod
                "t_box": "t_box:0",
                "t_mesh": "t_mesh:0",
                # add output tensors
                "t_energy": "o_energy:0",
    ...
    def _eval_inner(
        ...
        # evaluate
        feed_dict_test = {}
        #------insder cjx mod : make natoms_banidx
        natoms_banidx = np.zeros(len(natoms_vec)).astype(int)
        feed_dict_test[self.t_natoms_banidx] = natoms_banidx
        print("---cjx mod: get the natoms_banidx from data file---")
        print(natoms_banidx)
        #--------end of cjx mod---------------------
